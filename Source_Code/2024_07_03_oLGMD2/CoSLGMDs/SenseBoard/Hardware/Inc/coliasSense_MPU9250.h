...
typedef struct 
{
	CoS_MPU9250_TypeDef * Instance; 
	CoS_LockTypeDef Lock; 
	__IO CoS_StatusTypeDef iState;
}CoS_MPU9250_HandleTypeDef;

typedef struct{
	CoS_MPU9250_TypeDef* Instance;

}CoS_MPU9250_InitTypeDef;



typedef struct
{
	CoS_sI2C_HandleTypeDef* hHMPU;
	CoS_CCSTypeDef CC;
	float ax;
	float ay;
	float az;
	...
	uint8_t do_LED_flash;
}Tilt_detectTypedef;

extern Tilt_detectTypedef TiltSense;
