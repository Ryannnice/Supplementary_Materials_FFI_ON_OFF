...
/*
CoS_CCSTypeDef CC��������[ͨ�ÿ�����]�����ڹ��������˵ĸ��ֻ������ƹ��ܡ�

CoS_UART_HandleTypeDef* hHUART����һ��ָ��[ UART ���]��ָ�룬���������������豸������ͨ�š�

ColiasBasicEN_Type ACK��������һ����ʾ[ACK״̬]�ı�־������ȷ��ͨ�Ż�ִ��״̬��

IT_Events_TypeDef IT_Events����������[�ж�]�¼���صĽṹ��������ͬ���͵Ĵ��������˶��жϡ�

uint8_t timecount��������һ��[��ʱ��]�����ڸ����˶��������¼���ʱ�䡣

uint8_t MotionFinishFlag��������һ��[��־]����ʾ�˶�[�Ƿ����]��״̬��

Colias_Bumper_Inter bumper_inter����������[��ײ������]��صĽṹ�����ڼ��������Ƿ��������ϰ��       
*/
typedef struct
{
	...
	*/
	...
	ColiasBasicEN_Type	ACK; // [Ack]nowledgment
